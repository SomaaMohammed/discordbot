...
const COMMAND_METRIC_PATTERN =
  /^command_(?:usage|failures)\.(?:access|application|config|data|setup|superior|panel|suggestion|ticket|utility|fun|greetings|pingrole|restrictedping)\.[a-z0-9][a-z0-9._-]*$/;
